...
export default function TodoButton({id,done}:{id:string,done:boolean}){
    return (
        <div className="list__marker" onClick={()=>updateTodo(id)}>
                {done?(<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
